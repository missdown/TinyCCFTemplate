...
public:
  ...
  bool Initialize( const vector<const char *> &patterns, 
                   bool bCaseSensitive = false, bool bIncludeSpecialCharacters = false, bool bIncludeExtendedAscii = false );
  bool Search( size_t TextLength, const char *Text, const vector<const char *> &patterns );
protected:
  ...
  multimap<unsigned int,structPatternMap> m_vPatternMap;
